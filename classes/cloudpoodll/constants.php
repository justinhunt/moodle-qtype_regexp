...
namespace qtype_regexp\cloudpoodll;

defined('MOODLE_INTERNAL') || die();

class constants {
    const M_COMPONENT='qtype_regexp';
    const M_TABLE='qtype_regexp';
    ...
    const CLASS_REC_CONTAINER ='regexp_cloudpoodll_rec_cont';
    const CLASS_REC_OUTER ='regexp_cloudpoodll_rec_outer';
    const ID_REC ='regexp_cloudpoodll_therecorder';
    const ID_UPDATE_CONTROL ='regexp_cloudpoodll_updatecontrol';
    ...
    const LOADER_URL ='/question/type/regexp/cloudpoodll/cloudpoodllloader.html';
    const REFRESH_URL = '/question/type/regexp/cloudpoodll/refreshtoken.php';
}